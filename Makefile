...
inc/JSNativeType.inc: src/JSNative/JSNativeType.js
	# JSNativeType.js is being reconstructed
	@bin/bin2inc JSNativeTypeInit $< > $@;
...
${APPLICATION}: ${SOURCE} ${REQUIRES} $(shell echo inc/JSNative{Class,Type,}.inc) inc/JSTools.inc
	@echo ''
